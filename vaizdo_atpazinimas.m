...
% !!! MAŽINANT NEURONŲ SKAIČIŲ PRASTĖJA ŽODŽIŲ NUSTATYMAS. TEISINGAI
% ŽODŽIUS NUSTATO JEIGU NAUDOJAME NEMAŽIAU 10 NEURONŲ !!!
...
pavadinimas = 'test_VILNIUSTECH.png';
pozymiai_patikrai = pozymiai_raidems_atpazinti(pavadinimas, 1);
